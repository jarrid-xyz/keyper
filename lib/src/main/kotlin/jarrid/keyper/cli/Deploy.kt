...
class Deploy :
    NoOpCliktCommand(
        help = "Deploy module implements Terraform Cloud Development Kit underneath. " +
                "It scans existing key configs generated by key module and programmatically " +
                "construct terraform provider, modules and resources accordingly. " +
